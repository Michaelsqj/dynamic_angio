function x = pogm_LLR_sub(bpb, coils, dd, lambda, patch_size, im_size, niter)
%   Mark Chiew  
%   May 2021
%
...
%   Initialise
    ...
    p   =   patch_size;
    % L   =   1/E.max_step(10);
    L   =   1/max_step(10, bpb, coils, [[prod(size(dd,1:3)) size(dd,4)];]);
...
for iter = 1:niter
    ...
    %   y-update
    y0  =   y;
    y   =   x - (1/L)*(mtimes2(x, bpb, coils)-dd);
